...
public class TFGController {
    ...
    */
    ...
    // porque coincide con el del método
        ...
        return ResponseEntity.created(new URI("/tfgs/" + //te devuelve un 201 created si ha iddo bien
        ...
        {
        return (ResponseEntity<TFG>) tfgRepository.findById(id).map(tfg -> extracted(newTFG, tfg)).orElse(new ResponseEntity<TFG>(HttpStatus.NOT_FOUND));
        }

        private Object extracted(TFG newTFG, TFG tfg) {
        ...
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
            content = {
                ...
                "attachment; filename=\"tfg_document_" + id + ".pdf" + "\"") //nombre que pones al descargar
